...
public class Kasir {
    ...
    public void tampilkanDaftarMeja() {
        ...
        for (int i = 0; i < daftarMeja.length; i++) {
            ...
            String status = pelanggan != null ? "terisi oleh pelanggan " + pelanggan.getNama() : "kosong";
    ...
    public void tambahPesanan(int nomorMeja, Menu menu) {
        ...
        if (meja.isKosong()) {
            ...
            meja.tambahPesanan(menu);
            System.out.println("Menu yang ditambahkan: " + menu.getNama() + " - Rp." + menu.getHarga());
        }
    }
    ...
    public void hapusPelanggan(int nomorMeja) {
        if (!daftarMeja[nomorMeja - 1].isKosong()) {
            ...
            System.out.println("Pelanggan berhasil dihapus dari meja " + nomorMeja);
        } else {
        ...
        while (pilihan != 0) {
            ...
            switch (pilihan) {
                ...
                case 3:
                    ...
                    if (daftarMeja[nomorMejaPesan - 1].isKosong()) {
                        System.out.println("Meja belum terisi oleh pelanggan");
                    } else {
                        tampilkanDaftarMenu();
                        ...
                        while (!stopLoop) {
                            ...
                            if (nomorMenuPesan == 6) {
                                stopLoop = true;
                            } else if (nomorMenuPesan >= 1 && nomorMenuPesan <= 5) {
                                tambahPesanan(nomorMejaPesan, daftarMenu[nomorMenuPesan - 1]);
                            } else {
